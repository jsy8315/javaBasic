...
public class Member {
    ...
    public void memberIdentify() { 
        ...
        try {
            BufferedReader reader = new BufferedReader(new FileReader("C:\\Users\\JungSuyoung\\Documents\\GitHub\\javaBasic\\finalproject\\member.csv"));
            String line;
    ...
    public void memberAdd() {
    	...
    	while (shouldContinue122) { // 세번째 while문 중 두번째 메소드
            ...
            try {
                ...
                BufferedWriter writer = new BufferedWriter(new FileWriter("C:\\Users\\JungSuyoung\\Documents\\GitHub\\javaBasic\\finalproject\\member.csv", true)); // true는 append모드임을 나타냄
                writer.write("\n");
    ...
    public void memberDelete() {
    	...
    	while (shouldContinue123) { // 세번째 while문 중 두번째 메소드
    		...
    		// 3.을 하기전 4. 직전회원 삭제 취소를 위해 삭제 전 파일을 복사해놓자
    		 String sourceFile = "C:\\Users\\JungSuyoung\\Documents\\GitHub\\javaBasic\\finalproject\\member.csv";
    	     String destinationFile = "C:\\Users\\JungSuyoung\\Documents\\GitHub\\javaBasic\\finalproject\\memberBeforeDelete.csv";
    ...
    // 4.직전회원삭제취소
        public void memberDeleteRecovery() {
        	...
        	while (shouldContinue124) { // 세번째 while문 중 두번째 메소드
       		 ...
       		 String sourceFile = "C:\\Users\\JungSuyoung\\Documents\\GitHub\\javaBasic\\finalproject\\memberBeforeDelete.csv";
    	     String destinationFile = "C:\\Users\\JungSuyoung\\Documents\\GitHub\\javaBasic\\finalproject\\member.csv";
    	     // memberBeforeDelete란 이름으로 복사
